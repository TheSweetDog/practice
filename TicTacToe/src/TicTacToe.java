...
public class TicTacToe implements ActionListener {
    ...
    TicTacToe() {
        ...
        title_panel.setBounds(100, 150, 500, 150);

        reset_panel.setLayout(new BorderLayout());
        reset_panel.setBounds(100, 150, 500, 150);
        ...
        for (int i = 0; i < 9; i++) {
            ...
            buttons[i].setBackground(new Color(0, 0, 35));
            buttons[i].addActionListener(this);
        }

        reset.setBounds(130, 50, 100, 40);
    ...
    public void check() {
        for (int i = 0; i < 9; i++) {
            if ((buttons[0].getText() != "") && (buttons[1].getText() != "") && (buttons[2].getText() != "")
                    ...
                    (buttons[5].getText() != "") && (buttons[6].getText() != "") && (buttons[7].getText() != "")
                    && (buttons[8].getText() != "")) {
